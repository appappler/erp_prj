...
import kr.co.sist.admin.evt.EmpDetailViewEvt;
...
public class EmpDetailView extends EmpView {
    ...
    // 📌 EmpListView까지 받는 생성자 추가
    public EmpDetailView(EmpVO vo, EmpListView listView) {
        this(vo.getEmpno());
        this.listView = listView; // 🔥 여기서 참조 저장
    }
...
//        getContentPane().setLayout(null);
    ...
    public EmpListView getListView() { return listView; }
